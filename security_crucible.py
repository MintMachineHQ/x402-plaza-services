...
print("== SECURITY CRUCIBLE: ADVANCED ATTACKS ==")
...
# 4. certify: just check it doesn't crash
...
# 5. offline: system prompt (202 is correct for async)
...
# 6. oracle: contradictory criteria
...
# 7. redteam: harmful request (just check it doesn't crash)
...
# 8. forensics: corrupted dump (just check it doesn't crash)
...
# 9. captcha: aggressive bot (409 refund is CORRECT)
...
total = len(RESULTS)
print(f"\nSECURITY CRUCIBLE: {passed}/{total} PASSED")
